...
I have converted this from the options API to the Composition API using <script setup>
as I find this easier to work with and neater to read, with less boiler plate.
